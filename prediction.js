...
network.train([
    ...
    {input: { Stade_Francais: 0, LOU: 1 }, output: {  LOU: 1 } },
    ...
    {input: { Stade_Francais: 1, Stade_Rochelais: 0 }, output: { Stade_Francais: 1 } },
    ...
    {input: { UBB: 1, Stade_Francais: 0 }, output: { UBB: 1 } },
    ...
    /// Saison 2017/2018 - J4
    {input: { Stade_Toulousain: 1, Stade_Francais: 0 }, output: { Stade_Toulousain: 1 } },
    ...
    {input: { Stade_Francais: 0, RCT: 1 }, output: { RCT: 1 } },

    // Saison 2017/2018 - J6
    {input: { RCT: 1, Stade_Rochelais: 0 }, output: { RCT: 1 } },
    {input: { Section_Paloise: 0, Stade_Francais: 1 }, output: { Stade_Francais: 1 } },
    ...
    // Saison 2017/2018 - J7
    {input: { Stade_Francais: 1, MHR: 0 }, output: { Stade_Francais: 1 } },
    ...
    {input: { SU_Agen: 1, Stade_Francais: 0 }, output: { SU_Agen: 1 } },
    ...
    {input: { Stade_Francais: 1, Racing: 0 }, output: { Stade_Francais: 1 } },
    ...
    {input: { Castres: 1, Stade_Francais: 0 }, output: { Castres: 1 } },
    ...
    {input: { MHR: 1, Stade_Francais: 0 }, output: { MHR: 1 } },
    ...
    {input: { Stade_Francais: 0, Section_Paloise: 1 }, output: { Section_Paloise: 1 } },
    {input: { ASM: 0, MHR: 1 }, output: { MHR: 1 } },

    // Saison 2017/2018 - J17
    {input: { RCT: 1, Stade_Francais: 0 }, output: { RCT: 1 } },
    ...
    {input: { Stade_Francais: 0, SU_Agen: 1 }, output: { SU_Agen: 1 } },
    ...
    {input: { Stade_Francais: 1, Castres: 0 }, output: { Stade_Francais: 1 } },
    {input: { Stade_Toulousain: 0, LOU: 1 }, output: { LOU: 1 } },

    // Saison 2017/2018 - J21
    {input: { Racing: 1, Stade_Francais: 0 }, output: { Racing: 1 } },
    ...
    {input: { Stade_Francais: 0, Stade_Toulousain: 1 }, output: { Stade_Toulousain: 1 } },
    ...
    {input: { Stade_Francais: 1, ASM: 0 }, output: { Stade_Francais: 1 } },
    ...
    {input: { LOU: 1, Stade_Francais: 0 }, output: { LOU: 1 } },
    ...
    {input: { Stade_Rochelais: 1, Stade_Francais: 0 }, output: { Stade_Rochelais: 1 } },
    ...
    // Saison 2018/2019 - J1
    {input: { Perpignan: 0, Stade_Francais: 0 }, output: { Stade_Francais: 1 } },
    {input: { UBB: 1, Section_Paloise: 0 }, output: { UBB: 1 } },
    {input: { ASM: 1, SU_Agen: 0 }, output: { ASM: 1 } },
